The JSTL `<c:out>` tag or `fn:escapeXml()` function convert any HTML special characters into their HTML encodings, meaning they will then *not* be processed as standard HTML.
